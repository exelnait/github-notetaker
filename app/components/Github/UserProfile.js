        ...
        return (
            <div>
                ...
                <ul className="list-group">
                    ...
                    {Boolean(this.props.bio.followers) && <li className="list-group-item">Followers: {this.props.bio.followers}</li>}
                    {Boolean(this.props.bio.following) && <li className="list-group-item">Following: {this.props.bio.following}</li>}
                    {this.props.bio.public_repos && <li className="list-group-item">Public Repositories: {this.props.bio.public_repos}</li>}
